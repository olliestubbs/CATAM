...
with open('data3.p','rb') as in1:
    datapoints1 = pickle.load(in1)
with open('data4.p','rb') as in2:
...
xaxis4=1-H(yaxis4/2)
plt.scatter(xaxis1,yaxis1,label='method 3',alpha=0.3,marker='x')
plt.scatter(xaxis2,yaxis2,label='method 4',alpha=0.2)
